...
contract ReserveShareOverflowTest is Test {
    ...
    function testReserve() public {
        ...
        ValueFacet(diaA).addValue(whale, _cid, 2_000_000e18, 0);
        ...
        ValueFacet(diaA).addValue(bob, _cid, 450, 0);
        ...
        for (uint256 i = 0; i < 450; i++) {
            ValueFacet(diaA).removeValue(bob, _cid, 1, 0);
        }
        ...
        ValueFacet(diaA).removeValue(whale, _cid, 2_000_000e18, 0);
    }
}
