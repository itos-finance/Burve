...
address constant BEPOLIA_ROUTER = 0xADEC0cE4efdC385A44349bD0e55D4b404d5367B4;
address constant BERACHAIN_ROUTER = 0xFd88aD4849BA0F729D6fF4bC27Ff948Ab1Ac3dE7;

contract OpenerV2 is RFTPayer, Auto165, ReentrancyGuardTransient, Ownable {
    ...
    function mint(
        ...
        // Validate spend meets minimum expectations. Dust stays on the contract.
        for (uint256 i = 0; i < tokens.length; i++) {
    ...
    /// @notice Sweep accumulated dust of a given token to a specified address.
    /// @param token The ERC20 token to sweep.
    /// @param to The recipient address.
    function collectDust(address token, address to) external onlyOwner {
